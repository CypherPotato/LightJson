...
#pragma warning restore IL2072
	...
	private static JsonValue SerializeObjectAot(object? value, int deepness, bool convertersEnabled, IJsonTypeInfoResolver typeResolver, JsonSerializerOptions serializerOptions, JsonOptions options)
	{
		if (deepness > options.DynamicObjectMaxDepth)
		{
			throw new JsonException("The JSON serialization reached it's maximum depth.");
